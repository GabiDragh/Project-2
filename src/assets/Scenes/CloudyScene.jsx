     ...
     return (
        ...
        <div id="hero">
            ...
            <div style={{ position: 'absolute', bottom: '20px', left: '50%', transform: 'translateX(-50%)', textAlign: 'center' }}>
                <p style={{ fontSize: '24px', marginBottom: '20px' }}>Neither good nor bad! A bit cloudy, but good enough for a walk!</p>
                <button onClick={handleWeatherForecastClick} style={{ fontSize: '18px', marginRight: '10px' }}>Weather Forecast</button>
                <button onClick={handleBookRecommendationsClick} style={{ fontSize: '18px' }}>Let's go for a walk!</button>
        </div>
        </div>
