     ...
     return (
        ...
        <div id="hero">
            ...
            <div style={{ position: 'absolute', bottom: '20px', left: '50%', transform: 'translateX(-50%)', textAlign: 'center' }}>
                    <p style={{ fontSize: '24px', marginBottom: '20px' }}>Hey! I am WeatherRebel, your friend with the latest weather information and fun stuff to do rain or shine. To get started, just let me know the place you are interested in.</p>
            </div>
        </div>
